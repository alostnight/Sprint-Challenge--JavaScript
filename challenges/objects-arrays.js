...
const rex = { name: "Tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous"};
const steg = { name: "Stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period: "Late Jurassic"};
const Velo = { name: "Velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceous"}
...
zooAnimals.filter(element => element.population < 5);
